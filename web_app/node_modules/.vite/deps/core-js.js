...
var require_global = __commonJS({
  "node_modules/core-js/internals/global.js"(exports, module) {
    ...
    check(typeof self == "object" && self) || check(typeof _global == "object" && _global) || // eslint-disable-next-line no-new-func -- fallback
    function() {
      return this;
...
var require_engine_is_node = __commonJS({
  "node_modules/core-js/internals/engine-is-node.js"(exports, module) {
    init_shim();
    var classof = require_classof_raw();
    module.exports = typeof import_process.default != "undefined" && classof(import_process.default) == "process";
  }
});
...
var require_array_buffer_transfer = __commonJS({
  "node_modules/core-js/internals/array-buffer-transfer.js"(exports, module) {
    ...
    module.exports = PROPER_TRANSFER && function(arrayBuffer, newLength, preserveResizability) {
      ...
      var a = new DataView2(newBuffer);
      var b = new DataView2(newNewBuffer);
      for (var i = 0; i < newByteLength; i++)
  ...
  "node_modules/core-js/modules/esnext.json.parse.js"() {
    ...
    Context.prototype = {
      ...
      parse: function() {
        ...
        throw SyntaxError2('Unexpected character: "' + chr + '" at: ' + i);
      },
      ...
      number: function() {
        ...
        if (at(source, i) == "0")
          ...
          throw SyntaxError2("Failed to parse number at: " + i);
        if (at(source, i) == ".")
          i = this.skip(IS_DIGIT, ++i);
        if (at(source, i) == "e" || at(source, i) == "E") {
          ...
          if (exponentStartIndex == i)
            throw SyntaxError2("Failed to parse number's exponent value at: " + i);
        }
...
var require_web_structured_clone = __commonJS({
  "node_modules/core-js/modules/web.structured-clone.js"() {
    ...
    var RangeError2 = global.RangeError;
    var ReferenceError2 = global.ReferenceError;
    var SyntaxError2 = global.SyntaxError;
    var TypeError2 = global.TypeError;
...
var require_web_set_timeout = __commonJS({
  "node_modules/core-js/modules/web.set-timeout.js"() {
    ...
    var global = require_global();
    var schedulersFix = require_schedulers_fix();
    var setTimeout2 = schedulersFix(global.setTimeout, true);
    $({ global: true, bind: true, forced: global.setTimeout !== setTimeout2 }, {
