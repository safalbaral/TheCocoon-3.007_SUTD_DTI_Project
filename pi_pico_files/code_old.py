...
pwm16 = pwmio.PWMOut(board.GP16, frequency=1000)
pwm17 = pwmio.PWMOut(board.GP17, frequency=1000)
motor_1 = motor.DCMotor(pwm16, pwm17)
motor_1.decay_mode = (motor.SLOW_DECAY)

pwm11 = pwmio.PWMOut(board.GP11, frequency=1000)
